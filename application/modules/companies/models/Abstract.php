...
abstract class Companies_Model_Abstract extends Zend_Db_Table_Row_Abstract {
	 ...
	 * @throws Companies_Model_Abstract если не существует
	 */
	public function __get($columnName) {
		if (! array_key_exists ( $columnName, $this->_data )) {
			throw new Companies_Model_Exception ( "Неизвестное значение '$columnName' " );
		}
	...
	public function commit() {
		...
		try {
			...
			//$db->rollBack();
			throw new Companies_Model_Exception( $e );
		}
		return $result;
	}
}