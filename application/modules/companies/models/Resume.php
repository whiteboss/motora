...
class Companies_Model_Resume extends Companies_Model_Abstract {
	...
	protected static $_driving_permits = array(
		'Водит. прав нет', 'Категория B', 'Категория C', 'Категория D', 'Категория E'
	);
	...
	public static function getEducationTypes() {
		return Companies_Model_Vacancy::getEducationTypes();	
	}
	...
	public static function getScheduleTypes() {
		return Companies_Model_Vacancy::getScheduleTypes();	
	}
	...
	public static function getIndustries() {
		return Companies_Model_Vacancy::getIndustries();	
	}
	...
	public function getEmail() {
        ...
        public function getSalaryFrom() {
            if ($this->salary_from > 0) :
                return number_format( $this->salary_from, 0, ',', ' ' ); //return 'от ' . number_format( $this->salary_from, 0, ',', ' ' ) . 'руб.';
            else :
                return 'Любая';
            endif;
        }        
