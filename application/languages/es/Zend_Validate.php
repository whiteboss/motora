...
return array(
    ...
    "Value is required and can't be empty" => "Obligado para llenar",
    ...
    "Invalid type given, value should be a string" => "El tipo especificado es incorrecto, el valor debería ser una cadena de texto",
    "'%value%' is less than %min% characters long" => "Tiene menos de %min% caracteres.",
    "'%value%' is more than %max% characters long" => "Tiene más de %max% caracteres.",
);
