...
return array(
    ...
    "'%value%' no está en uso" => "No record matching '%value%' no está en uso",
    "'%value%' ya está en uso" => "'%value%' ya está en uso",

    // Zend_Validate_Digits
    "Invalid type given. String, integer or float expected" => "Invalid type given. String, integer or float expected",
    "'%value%' must contain only digits" => "'%value%' must contain only digits",
    "'%value%' contains characters which are not digits; but only digits are allowed" => "'%value%' must contain only digits",
    "'%value%' is an empty string" => "'%value%' is an empty string",
