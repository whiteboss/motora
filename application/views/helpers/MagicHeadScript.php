 ...
 */
class Application_Views_Helper_MagicHeadScript extends Zend_View_Helper_HeadScript
{
    ...
    public function toString($indent = null)
    {
        ...
        $headScript
            ...
            ->appendFile('/js/google.analytics.js')
            //->appendFile('/js/jquery.jcarousel.min.js')
            ;
    ...
    private function getCompiledItem()
    {
        ...
        $path = $_SERVER['DOCUMENT_ROOT'] . '/cache/' . $filename . (self::$compress? '_compressed' : '') . '.js';
        if (!file_exists($path)) {
            ...
            if (self::$compress) {
                $jsContent = Qlick_JSMin::minify($jsContent);
            }
